...
# project title
html_title = 'open qoob framework dox v1.0'
...
# basename
htmlhelp_basename = 'openqoobframeworkdox'
...
# latex info
latex_documents = [
  ('index', 'openqoob.tex', u'open qoob framework dox',
   u'xero harrison', 'manual'),
]

# man pages
man_pages = [
    ('index', 'openqoob', u'open qoob framework dox',
     [u'xero harrison'], 1)
]
...
texinfo_documents = [
  ('index', 'openqoob', u'open qoob framework dox',
   u'xero harrison', 'openqoobframeworkdox', 'open source php mvc framework framework implementation',
   'Miscellaneous'),
]
